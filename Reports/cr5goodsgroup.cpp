    ...
    C5ReportWidget(parent)
{
    ...
    fSqlQuery = R"(
    select gr.f_id, grp.f_name as f_parent, gr.f_name, gr.f_class, gr.f_taxdept, gm.f_name as f_markname,
    gr.f_adgcode, gr.f_chargevalue, g.qnt
    from c_groups gr
    left join c_groups grp on grp.f_id=gr.f_parent
    left join c_goods_mark gm on gm.f_id=gr.f_mark
