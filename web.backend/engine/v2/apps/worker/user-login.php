...
# Last Modified: 2025-12-01 20:27:50
...
class UserLogin extends Auth
{
    ...
    public function login($params)
    {
        ...
        $bearerToken = uuid_v4();
        if (!empty($params->forceconfig)) {
            $configValue = trim($params->forceconfig);
            $userdata["f_config"] = $configValue;
        }
    ...
    public function sendOTP($params)
    {
        ...
        if (substr($params->phone, 0, 4) != "+374") {
            dieWithCode("Are you international hacker?");
        }
